...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $operations = [
            'partner' => [
                'edit' => 'Umožnuje editaci partner',
                'delete' => 'Umožnuje smazání partner'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\Partner\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}